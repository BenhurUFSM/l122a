...
2. Faça uma função que lê de um arquivo aberto o número de matrícula, a data de nascimento, a média e o nome de um aluno, e retorna uma estrutura do tipo `aluno` definido abaixo
   ```c
   typedef struct {
     int dia;
     int mes;
